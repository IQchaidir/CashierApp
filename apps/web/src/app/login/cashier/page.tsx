...
const LoginCashierPage = () => {
    ...
    useEffect(() => {
        if (session && session.token && session.role === 'CASHIER') {
            return router.push('/cashier');
        } else if (session && session.token && session.role === 'ADMIN') {
            return router.push('/cashier');
        }
    }, [session]);
        ...
        <div className="flex bg-gray-300 items-center justify-center h-screen">
            <div className="bg-white rounded-lg shadow-xl w-96">
                <div className="p-8">
                    ...
                    <Separator />
                    <h2 className="mt-5 text-center text-3xl font-extrabold text-gray-900 mb-6">Sign in as Cashier</h2>
...
export default LoginCashierPage;
